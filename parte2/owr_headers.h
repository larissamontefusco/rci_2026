...
#define ROUTE_STATE_NONE 0
#define ROUTE_STATE_COORD 1
#define ROUTE_STATE_FORWARD 2
...
typedef struct route_entry {
    int valid;
    char dest[3];
    int state;        // ROUTE_STATE_*
    int dist;         // número de saltos até ao destino
    char next_hop[3]; // vizinho a usar quando state=FORWARD
} ROUTE_ENTRY;
